...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L27){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L54){target="_blank" style="float:right; font-size:smaller"}
...
The best is to first call the [`setup`](https://silvaac.github.io/token_data/hyperliquid.html#setup) function once to initialize the Hyperliquid Info client. Then pass "info" to any function that requires it. That will avoid calling the [`setup`](https://silvaac.github.io/token_data/hyperliquid.html#setup) function multiple times.
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L132){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L189){target="_blank" style="float:right; font-size:smaller"}
...
If you want to find out which ticker is used for a given coin, you can use the [`spot_tickers`](https://silvaac.github.io/token_data/hyperliquid.html#spot_tickers) function. For example, for Ethereum (ETH) quoted in USDC is:
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L225){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L242){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L246){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L333){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L463){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L540){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L588){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L614){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L844){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L1107){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/silvaac/token_data/blob/main/token_data/hyperliquid.py#L1374){target="_blank" style="float:right; font-size:smaller"}
